...
export class SnakeCaseTimestampColumns1788516000000 implements MigrationInterface {
  name = 'SnakeCaseTimestampColumns1788516000000';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "currency" RENAME COLUMN "createdAt" TO "created_at"`,
    );
    await queryRunner.query(
      `ALTER TABLE "currency" RENAME COLUMN "updatedAt" TO "updated_at"`,
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "currency" RENAME COLUMN "updated_at" TO "updatedAt"`,
    );
    await queryRunner.query(
      `ALTER TABLE "currency" RENAME COLUMN "created_at" TO "createdAt"`,
    );
  }
}
